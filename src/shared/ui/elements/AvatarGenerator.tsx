...
const Avatar: React.FC<AvatarProps> = ({ size = 120 }) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 100 100">
      ...
      {/* Волосы */}
      {hairStyle === 'short' && <Path d="M20,40 C30,10 70,10 80,40 Z" fill={hairColor} />}
      {hairStyle === 'curly' && <Path d="M20,40 Q50,5 80,40 Q65,10 35,40 Q50,15 20,40 Z" fill={hairColor} />}
      {hairStyle === 'long' && <Path d="M20,40 C20,10 80,10 80,40 L80,70 C80,80 20,80 20,70 Z" fill={hairColor} />}
      ...
      {/* Нос */}
      <Path d="M50 53 Q49 58 50 58 Q51 58 50 53" stroke="#000" strokeWidth="1" fill="none" />

      {/* Рот */}
      {mouthType === 'smile' ? (
        <Path d="M40 65 Q50 70 60 65" stroke="#000" strokeWidth="1.5" fill="none" />
      ) : (
